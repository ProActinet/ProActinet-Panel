  ...
  return (
    <section className="w-full h-[100vh] flex flex-col py-4 items-center">
      <div className="px-4 md:px-4 mb-8 ">
        <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">
          Welcome to Procti-Net.. {user?.user?.username}!
        </h1>
      </div>
      <div className="py-16">
        <div className="mx-auto px-6 max-w-6xl text-gray-500">
          <div className="relative">
            <div className="relative z-10 grid gap-3 grid-cols-6">
              <div className="col-span-full lg:col-span-2 overflow-hidden flex relative p-8 rounded-xl bg-gradient-to-b from-[#ffffff10] via-[#ffffff09] to-[#ffff1300] border border-pink-accent ">
                <div className="h-full  w-full m-auto relative">
                  <h3 className="mt-4 text-center font-semibold text-white text-3xl">
                    Overview{" "}
                  </h3>
                  <div className="relative mt-4 w-56 flex items-center">
                    <span className="w-full block mx-auto text-2xl font-semibold text-white">
                      User :{" "}
                  ...
                  <div className="relative mt-6 gap-y-6 w-full flex flex-col items-center">
                    <CircularProgressBar sqSize={100} percentage={1} />
                    <span className="w-full text-center block mx-auto text-2xl font-semibold text-white">
                      Connections 🟢
                    </span>
                  </div>
                </div>
              </div>
              <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-gradient-to-b from-[#ffffff10] via-[#ffffff09] to-[#ffff1300] border border-pink-accent">
                <div>
                  <div className="relative aspect-square rounded-full size-28 xl:size-32 flex border mx-auto  before:absolute before:-inset-2 before:border dark:before:border-white/5 dark:before:bg-white/5 before:rounded-full border-pink-accent before:border-pink-accent">
                    <svg
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          ...
                          ></stop>
                          <stop
                            className="text-yellow-400 dark:text-blue-500"
                            offset="1"
                  ...
                  <div className="mt-6 text-center relative z-10 space-y-2 [&>p]:text-left">
              ...
              <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl border-pink-accent border bg-gradient-to-b from-[#ffffff10] via-[#ffffff09] to-[#ffff1300]">
                <div>
                  <div className="pt-6 lg:px-6">
                    ...
                    >
                      ...
                      <g clipPath="url(#clip0_0_106)">
                        <circle
                          className="text-pink-accent dark:text-blue-500"
                          cx="29"
                          cy="29"
                          r="15"
                          fill="currentColor"
                      ...
                      <defs>
                        ...
                        >
                          <stop
                            className="text-yellow-300 dark:text-blue-600/30"
                            stopColor="currentColor"
                          ></stop>
                          <stop
                            className="text-yellow-500 dark:text-transparent"
                            offset="1"
                            stopColor="currentColor"
                  ...
                  <div className="mt-14 text-center relative z-10 space-y-2 [&>p]:text-left">
                    <h2 className="text-lg font-medium text-white transition ">
                      Statistics
                    </h2>
                    ...
                    <p className="text-white">
                      <span className="text-yellow-500">Daemon Status : </span>
                      <span
                        className={`${
                          false ? "text-green-500" : "text-orange-600"
                        }`}
                      >
                        {" "}
                        Offline
